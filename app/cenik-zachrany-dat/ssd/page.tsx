...
import { Cpu, Wrench, ArrowRight, Phone, ClipboardList } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Ceník obnovy dat z SSD | Solid State disky | DataHelp.cz',
  description: 'Kolik stojí záchrana dat z SSD? Ceny od 3 000 Kč. Vadný řadič, vadné bloky, firmware chyby. Specializované vybavení pro SSD. Bezplatná diagnostika.',
  alternates: {
    canonical: 'https://www.datahelp.cz/cenik-zachrany-dat/ssd',
  },
  openGraph: {
    title: 'Ceník obnovy dat z SSD | Solid State disky | DataHelp.cz',
    description: 'Kolik stojí záchrana dat z SSD? Ceny od 3 000 Kč. Vadný řadič, vadné bloky, firmware chyby. Bezplatná diagnostika.',
    url: 'https://www.datahelp.cz/cenik-zachrany-dat/ssd',
...
export default function SSDPricingPage() {
  ...
  const hardwareRows: PriceRow[] = [
    {
      ...
      price: '12 000 – 19 000 Kč',
      symptoms: 'Disk se nedetekuje v zařízení. Disk hlásí jinou kapacitu. Hlásí jiný název a sériové číslo.'
    },
    {
      damage: 'Vadné paměťové bloky',
      price: '7 000 – 14 000 Kč',
      symptoms: 'Disk není přístupný. Nelze číst ani zapisovat žádná data, disk vrací chyby čtení nebo zápisu.'
    },
    {
      damage: 'Chyba ve firmware',
      price: '7 000 – 12 000 Kč',
      symptoms: 'Disk hlásí jinou kapacitu, jiný název. Firmware řídí veškerou činnost SSD.'
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader
        title="Ceník obnovy dat z SSD"
        subtitle="Solid State disky – orientační ceny dle typu poškození"
      />
      <Breadcrumbs />
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto mb-8">
          <p className="text-gray-700 text-lg mb-4">
            Záchrana dat z SSD disků vyžaduje specializované vybavení a znalosti. Na rozdíl od HDD nemají SSD mechanické části,
            ale používají flash paměťové čipy, které vyžadují specifický přístup k obnově dat.
          </p>
          <p className="text-gray-600">
            U SSD je důležité médium co nejdříve odpojit od napájení, aby nedošlo k dalšímu přepisování dat funkcí TRIM.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-primary mb-3">Specifika záchrany dat z SSD</h3>
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start">
              <span className="text-accent mr-2">•</span>
              <span>SSD disky používají funkci TRIM, která může trvale smazat data – rychlé odpojení je klíčové.</span>
            </li>
            <li className="flex items-start">
              <span className="text-accent mr-2">•</span>
              <span>Hardwarové závady vyžadují práci s NAND čipy a specializovaný software.</span>
            </li>
            <li className="flex items-start">
              <span className="text-accent mr-2">•</span>
              <span>Šifrované SSD (např. s TPM) mohou být náročnější na obnovu.</span>
            </li>
          </ul>
        </div>

        <div className="max-w-4xl mx-auto mt-12 text-center">
          <h3 className="text-2xl font-bold text-primary mb-4">Potřebujete zachránit data z SSD?</h3>
        ...
        <div className="max-w-4xl mx-auto mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            >
              ...
              Záchrana dat z SSD – více informací
            </Link>
            <Link
