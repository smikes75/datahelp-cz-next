...
/**
 * SSD Case Studies stránka
 */

import { useState, useEffect } from 'react';
import { Cpu, CheckCircle, Clock, Banknote } from 'lucide-react';
...
export default function SSDCaseStudies() {
  ...
  const ssdCases = t.raw('caseStudies.ssd') as CaseStudy[];
