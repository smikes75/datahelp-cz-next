...
/**
 * RAID Case Studies stránka
 */

import { useState, useEffect } from 'react';
import { Server, CheckCircle, Clock, Banknote } from 'lucide-react';
...
export default function RAIDCaseStudies() {
  ...
  const raidCases = t.raw('caseStudies.raid') as CaseStudy[];
